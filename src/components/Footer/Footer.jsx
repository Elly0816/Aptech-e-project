...
const Footer = () => {
  ...
  const [activeTab, setActiveTab] = useState(() => {
    ...
    if (pathname.toLowerCase().includes('continents')) return 'Continents';
    if (pathname.toLowerCase().includes('gallery')) return 'Gallery';
    if (pathname.toLowerCase().includes('saved')) return 'Saved';
    if (pathname.toLowerCase().includes('about')) return 'About';
    if (pathname.toLowerCase().includes('monument')) return 'Monument';
    return 'Explore';
  });
